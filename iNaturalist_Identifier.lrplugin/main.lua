...
------------------------------------------------------------
Numbered Steps
1. Import the `AnimalIdentifier` module containing the identification logic.
2. Call the `identify()` function from this module to perform identification.

------------------------------------------------------------
Called Scripts
- AnimalIdentifier.lua (main identification module)
...
-- [Step 2] Call the 'identify' function defined in the AnimalIdentifier module
identifyanimal.identify()
