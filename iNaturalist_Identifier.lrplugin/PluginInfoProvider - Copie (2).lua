...
configuring iNaturalist integration and plugin updates.
...
- Logger.lua
- Update_plugin.lua (provides getCurrentVersion() and getLatestGitHubVersion())
- TokenUpdater.lua
...
8. Create Save button for preferences.
9. Return dialog UI layout.
====================================================================
--]]
...
local Updates = require("Update_plugin")  -- Provides getCurrentVersion() and getLatestGitHubVersion()
...
return {
    sectionsForTopOfDialog = function(viewFactory)
        ...
        -- Step 8: Save button for preferences
        ...
        -- Step 9: Return dialog UI layout
